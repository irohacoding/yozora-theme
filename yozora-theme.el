...
(let* ((yozora-petal  "#252525")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-comment-face
     ((((class grayscale)) (:slant italic :weight bold :foreground ,yozora-cloud))
      (((class color) (min-colors 88) (background dark)) (:foreground ,yozora-star))
      (((class color) (min-colors 16) (background dark)) (:foreground ,yozora-star))
      (((class color) (min-colors 8) (background dark)) (:foreground ,yozora-star))
   ...
   `(isearch-fail ((((class color) (min-colors 88)) (:foreground ,yozora-bird :background ,yozora-heart))
                   (((class color) (min-colors 16)) (:foreground ,yozora-bird :background ,yozora-heart))
                   (((class color) (min-colors 8)) (:foreground ,yozora-bird :background ,yozora-heart))
                   (((class color grayscale)) (:foreground ,yozora-cloud))
                   (t (:inverse-video t))))
   `(lazy-highlight ((((class color) (min-colors 88)) (:background ,yozora-sky))
                     (((class color) (min-colors 16)) (:background ,yozora-sky))
                     (((class color) (min-colors 8)) (:background ,yozora-sky))
